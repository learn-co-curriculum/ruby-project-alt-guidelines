class PantryApp
 ...
 #       main_screen
    ...
    def add_helper
        ...
        puts "Congratulations! You added #{new_fav.resource.name} to your resources."
        sleep(2.0)
        main_screen
    end
    ...
    def delete_helper
        select_helper
        answer = prompt.yes?("Delete this resource?")
        if answer
        @selected_resource.destroy
        end
        puts "You deleted #{selected_resource.nickname}."
        sleep(1.5)
        main_screen
